package com.externalwebapi.jonsmiley;
...
@Configuration
@ComponentScan({ "com.externalwebapi.jonsmiley" })
    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.externalwebapi.jonsmiley");
                servletContext.setInitParameter("tapestry.development-modules", "com.externalwebapi.jonsmiley.services.DevelopmentModule");
